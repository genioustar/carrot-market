    ...
    <div className="px-5 py-10">
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <p className="mt-3 text-3xl font-semibold text-gray-900">$140</p>
          ...
          <div className="flex items-center justify-between space-x-2">
            ...
            <button className="flex items-center justify-between rounded-md p-3 text-gray-400 hover:bg-gray-100 hover:text-gray-500">
              <svg
                className="h-6 w-6 "
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              ...
              <h3 className="-mb-1 font-semibold text-gray-700">Galaxy S60</h3>
              <span className="test-sm test-gray-900 font-semibold">$6</span>
            </div>
          ))}
        </div>
      </div>
